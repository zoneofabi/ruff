...
function activateJoystickActiveSwitch(){
  ...
  //triggering the HUD top green lights to blink
  updateHUDLights();
...
//START OF HUD LIGHT FUNCTIONS
function updateHUDLights(){

  //triggering the top green arrows to blink if joystick is active
  if(joystickActiveSwitch==true){
    console.log("UpdateHUDLights being called");
    let topGreenBlinker_Left = document.querySelector(".CamVLeftHUDLightPanel_GreenArrow:nth-of-type(1)");

    //debug notes: we are succesfully getting the SVG element in the code below. Now just figure out how to get the path within it
    let topGreenBlinker_Left_path = topGreenBlinker_Left.children[0];

    //we are getting the path of the svg elemenet here.
    topGreenBlinker_Left_path = topGreenBlinker_Left_path.children[0];
    
    console.log("path retrival attemp: " + topGreenBlinker_Left_path);
   
    
   
   
    let topGreenBlinker_Right = document.querySelector(".CamVRightHUDLightPanel_GreenArrow:nth-of-type(1)");

    topGreenBlinker_Left_path.classList.toggle("hudArrows_TopGreenArrowsBlinking");
    topGreenBlinker_Right.classList.toggle("hudArrows_TopGreenArrowsBlinking");
